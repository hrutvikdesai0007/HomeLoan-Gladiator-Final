...
@SpringBootTest
public class PrimarykeyForeignKeyTestCases2 {
	@Autowired
	...
	@Test//test 18
	void insertEverythingIntoDebtorSecondCase() {
		...
		Debtor db=new Debtor("gavrav", "DVDs", "DVDs", "uran", "d@d.com", "123", "123", "1234", date, "M", "Indian", "12377723", "EEEWWW123");
		Set<Loan> loans=new HashSet<Loan>();
		//Loan(int applicationId, int debtorSalary, int loanAmount, int interestRate, int tenure, Debtor debtors1)
		Loan ll=new Loan(100, 10000, 8, 9, db);
		...
		LoanTracker lt=new LoanTracker( ll, "1234", "Pending", "Rejected", "remarked", "123", 10);
		...
		Docs dd=new Docs("asdsadssa", "asdzcxzxc", null, null, null, null, null, db);
		db.setDocs(dd);
		base.saveRecord(db);
	}
	/*
